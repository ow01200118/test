...
#define G_FUNC(v)																				\
	SS_TBL[0][(IOTZ_UBYTE)      (v) & 0xff] ^ SS_TBL[1][(IOTZ_UBYTE) ((v)>>8) & 0xff] ^	\
	SS_TBL[2][(IOTZ_UBYTE)((v)>>16) & 0xff] ^ SS_TBL[3][(IOTZ_UBYTE)((v)>>24) & 0xff]

#define KEYSCHEDULE_UPDATE0_128(T0, T1, X1, X2, X3, X4, KC)	\
	(T0) = (X3);											\
...
#define KEYSCHEDULE_UPDATE1_128(T0, T1, X1, X2, X3, X4, KC)	\
	(T0) = (X1);											\
...
static IOTZ_UWORD SS_TBL[4][256] =
{
    {
...
IOTZ_RETURN expand_key_seed(IOTZ_UWORD* rk, const IOTZ_UWORD* key, const IOTZ_INT keyLen)
{
    IOTZ_UWORD x1, x2, x3, x4;
    IOTZ_UWORD t0, t1;
    ...
    t1 = (x2 - x4 + KC0) & 0xffffffff;						KEYUPDATE_TEMP(t0, t1, &rk[0]);
    KEYSCHEDULE_UPDATE1_128(t0, t1, x1, x2, x3, x4, KC1);	KEYUPDATE_TEMP(t0, t1, &rk[2]);
    KEYSCHEDULE_UPDATE0_128(t0, t1, x1, x2, x3, x4, KC2);	KEYUPDATE_TEMP(t0, t1, &rk[4]);
    KEYSCHEDULE_UPDATE1_128(t0, t1, x1, x2, x3, x4, KC3);	KEYUPDATE_TEMP(t0, t1, &rk[6]);
    KEYSCHEDULE_UPDATE0_128(t0, t1, x1, x2, x3, x4, KC4);	KEYUPDATE_TEMP(t0, t1, &rk[8]);
    KEYSCHEDULE_UPDATE1_128(t0, t1, x1, x2, x3, x4, KC5);	KEYUPDATE_TEMP(t0, t1, &rk[10]);
    KEYSCHEDULE_UPDATE0_128(t0, t1, x1, x2, x3, x4, KC6);	KEYUPDATE_TEMP(t0, t1, &rk[12]);
    KEYSCHEDULE_UPDATE1_128(t0, t1, x1, x2, x3, x4, KC7);	KEYUPDATE_TEMP(t0, t1, &rk[14]);
    KEYSCHEDULE_UPDATE0_128(t0, t1, x1, x2, x3, x4, KC8);	KEYUPDATE_TEMP(t0, t1, &rk[16]);
    KEYSCHEDULE_UPDATE1_128(t0, t1, x1, x2, x3, x4, KC9);	KEYUPDATE_TEMP(t0, t1, &rk[18]);
    KEYSCHEDULE_UPDATE0_128(t0, t1, x1, x2, x3, x4, KC10);	KEYUPDATE_TEMP(t0, t1, &rk[20]);
    KEYSCHEDULE_UPDATE1_128(t0, t1, x1, x2, x3, x4, KC11);	KEYUPDATE_TEMP(t0, t1, &rk[22]);
    KEYSCHEDULE_UPDATE0_128(t0, t1, x1, x2, x3, x4, KC12);	KEYUPDATE_TEMP(t0, t1, &rk[24]);
    KEYSCHEDULE_UPDATE1_128(t0, t1, x1, x2, x3, x4, KC13);	KEYUPDATE_TEMP(t0, t1, &rk[26]);
    KEYSCHEDULE_UPDATE0_128(t0, t1, x1, x2, x3, x4, KC14);	KEYUPDATE_TEMP(t0, t1, &rk[28]);
    KEYSCHEDULE_UPDATE1_128(t0, t1, x1, x2, x3, x4, KC15);	KEYUPDATE_TEMP(t0, t1, &rk[30]);

    return 0;
}

IOTZ_RETURN crypt_seed(IOTZ_UWORD* output, const IOTZ_UWORD* input, const IOTZ_INT keyLen, const IOTZ_BLOCK_ENC_DEC sit, const IOTZ_UWORD* rk)
{
    IOTZ_UWORD x1, x2, x3, x4;
    IOTZ_UWORD t0, t1;
