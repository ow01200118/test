...
#define IOTZ_FRAME_CIPHER_CODE_ERROR        1
#define IOTZ_BLOCK_CIPHER_ALGORITHM_ERROR   1
#define IOTZ_BLOCK_CIPHER_MODE_ERROR        1
#define IOTZ_BLOCK_CIPHER_ENCDEC_ERROR      1
#define IOTZ_BLOCK_CIPHER_TAG_ERROR      1
